...
#line 741
typedef int (*__compar_fn_t)(const void *arg_0xb7c14458, const void *arg_0xb7c145f0);
#line 779
__extension__ 
#line 796
__extension__ 
...
#line 260
extern double erfc(double arg_0xb7bc58c8) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 336
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0xb7a6f840), 
int (*key_eq_fn)(void *arg_0xb7a6fc88, void *arg_0xb7a6fe00));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0xb793e9b8, int arg_0xb793eb10);
static double RandomUniform(void );
...
# 30 "RadioRouteC.nc"
radio_route_msg_t *RadioRouteC$rrm[1000];
const uint8_t RadioRouteC$codice_persona[1000][8];

uint8_t RadioRouteC$msg_counter[1000];
uint8_t RadioRouteC$led_index[1000];

message_t RadioRouteC$packet[1000];



route_entry_t RadioRouteC$route_table[1000][8];
...
static bool RadioRouteC$actual_send(uint16_t address, message_t *packet);



static inline void RadioRouteC$initialize_route_table(void );
...
{
  LedsP$Led2$toggle();
  sim_log_debug(171U, "LedsC", "LEDS: Led""2"" %s.\n", LedsP$Led2$get() ? "off" : "on");
#line 116
  ;
}
...
#line 174
    {
      ...
      sim_log_debug(153U, "radio_rec", "Received packet of length %hhu.\n", len);

      RadioRouteC$rrm[sim_node()] = (radio_route_msg_t *)payload;
      if (__nesc_ntoh_uint16(RadioRouteC$rrm[sim_node()]->type.nxdata) == 0) {


          sim_log_debug(154U, "radio_rec", "Type0\n");
        }
      else {
#line 184
        if (__nesc_ntoh_uint16(RadioRouteC$rrm[sim_node()]->type.nxdata) == 1) {


            sim_log_debug(155U, "radio_rec", "Type1\n");
          }
        else {
#line 189
          if (__nesc_ntoh_uint16(RadioRouteC$rrm[sim_node()]->type.nxdata) == 2) {


              sim_log_debug(156U, "radio_rec", "Type2\n");
            }
          else {
              sim_log_error(157U, "radio_rec", "Invalid message type\n");
              return;
            }
          }
        }
#line 199
      sim_log_debug(158U, "radio_rec", "SENDER:%d  DESTINATION:%d   TYPE:%d\n", __nesc_ntoh_uint16(RadioRouteC$rrm[sim_node()]->sender.nxdata), __nesc_ntoh_uint16(RadioRouteC$rrm[sim_node()]->destination.nxdata), __nesc_ntoh_uint16(RadioRouteC$rrm[sim_node()]->type.nxdata));





      RadioRouteC$led_index[sim_node()] = RadioRouteC$codice_persona[sim_node()][RadioRouteC$msg_counter[sim_node()] % 8] % 3;

      if (RadioRouteC$led_index[sim_node()] == 0) {
          RadioRouteC$Leds$led0Toggle();
          sim_log_debug(159U, "led_0", "Led0 Toggled.\n");
        }
      else {
#line 211
        if (RadioRouteC$led_index[sim_node()] == 1) {
            RadioRouteC$Leds$led1Toggle();
            sim_log_debug(160U, "led_1", "Led1 Toggled.\n");
          }
        else {
#line 215
          if (RadioRouteC$led_index[sim_node()] == 2) {
              RadioRouteC$Leds$led2Toggle();
              sim_log_debug(161U, "led_2", "Led2 Toggled.\n");
            }
          else {
              return;
            }
...
#line 223
      RadioRouteC$msg_counter[sim_node()]++;
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0xb76e1ac8, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0xb76e1ac8) {
#line 78
    case 10:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0xb76e1ac8, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0xb76df178, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0xb76df178, msg, payload, len);
#line 78
...
{
  if (err == SUCCESS) {
      sim_log_debug(151U, "radio", "Radio started.\n");
      if (TOS_NODE_ID == 1) {
...
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0xb76e1108, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0xb76e1108, msg, error);
#line 110
}
#line 110
...
# 100 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0xb754d6a8, message_t * msg, error_t error){
#line 100
  switch (arg_0xb754d6a8) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0xb754d6a8, msg, error);
#line 100
      break;
#line 100
    }
...
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0xb789a650){
#line 75
  switch (arg_0xb789a650) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0xb789a650);
#line 75
      break;
#line 75
    }
...
#line 148
{
  ...
  sim_log_debug(152U, "timer", "Timer1 Fired\n");

  RadioRouteC$rrm[sim_node()] = (radio_route_msg_t *)RadioRouteC$Packet$getPayload(&RadioRouteC$packet[sim_node()], sizeof(radio_route_msg_t ));

  __nesc_hton_uint16(RadioRouteC$rrm[sim_node()]->type.nxdata, 0);
  __nesc_hton_uint16(RadioRouteC$rrm[sim_node()]->sender.nxdata, 1);
  __nesc_hton_uint16(RadioRouteC$rrm[sim_node()]->destination.nxdata, 7);
  __nesc_hton_uint16(RadioRouteC$rrm[sim_node()]->value.nxdata, 5);

  RadioRouteC$actual_send(2, &RadioRouteC$packet[sim_node()]);
}
...
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0xb73cc3a8){
#line 83
  switch (arg_0xb73cc3a8) {
#line 83
    case 0U:
#line 83
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0xb73cc3a8);
#line 83
      break;
#line 83
    }
...
#line 83
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0xb754b0a0, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0xb754b0a0, addr, msg, len);
#line 80
...
#line 60
  for (i; i < 8; i++) {
      RadioRouteC$route_table[sim_node()][i].next_hop = 0;
      RadioRouteC$route_table[sim_node()][i].value = 0;
    }
  sim_log_debug(148U, "boot", "Route table initialized\n");
}
...
#line 126
{
  sim_log_debug(150U, "boot", "APP BOOTED.\n");
  RadioRouteC$initialize_route_table();
  RadioRouteC$AMControl$start();
}
...
#line 115
{
  ...
  if (RadioRouteC$AMSend$send(address, packet, sizeof(radio_route_msg_t )) == SUCCESS) {
      sim_log_debug(149U, "radio_send", "Packet sent\n");
    }
}
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  /* Module RadioRouteC */
  if (!strcmp(varname, "RadioRouteC$rrm"))
  {
    *addr = (uintptr_t)&RadioRouteC$rrm[__nesc_mote];
    *size = sizeof(RadioRouteC$rrm[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "RadioRouteC$codice_persona"))
  {
    *addr = (uintptr_t)&*(unsigned char (*)
# 31 "RadioRouteC.nc"
    [8])&RadioRouteC$codice_persona[__nesc_mote];
    *size = sizeof(*(unsigned char (*)
#line 31
    [8])&RadioRouteC$codice_persona[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "RadioRouteC$msg_counter"))
  {
    *addr = (uintptr_t)&RadioRouteC$msg_counter[__nesc_mote];
    *size = sizeof(RadioRouteC$msg_counter[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "RadioRouteC$led_index"))
  {
    *addr = (uintptr_t)&RadioRouteC$led_index[__nesc_mote];
    *size = sizeof(RadioRouteC$led_index[__nesc_mote]);
    return 0;
  }
  ...
  if (!strcmp(varname, "RadioRouteC$route_table"))
  {
    *addr = (uintptr_t)&RadioRouteC$route_table[__nesc_mote];
    *size = sizeof(RadioRouteC$route_table[__nesc_mote]);
    return 0;
  }
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  /* Module RadioRouteC */
  RadioRouteC$rrm[__nesc_mote] = (void *)0;
  memcpy((void *)&*(unsigned char (*)[8])&RadioRouteC$codice_persona[__nesc_mote], (void *)&(unsigned char const [8]){ 1, 0, 6, 5, 7, 8, 1, 6 }, sizeof *(unsigned char (*)[8])&RadioRouteC$codice_persona[__nesc_mote]);
  RadioRouteC$msg_counter[__nesc_mote] = 0;
  RadioRouteC$led_index[__nesc_mote] = 0;
  memset((void *)&RadioRouteC$packet[__nesc_mote], 0, sizeof RadioRouteC$packet[__nesc_mote]);
  memset((void *)&RadioRouteC$route_table[__nesc_mote], 0, sizeof RadioRouteC$route_table[__nesc_mote]);
